...
class _EditBillScreenState extends State<EditBillScreen>
  ...
  void initState() {
    ...
    _category = widget.bill.categoryName ?? widget.bill.category;
    _payType = widget.bill.payType;
  ...
  Future<void> _save() async {
    ...
    await bp.updateBill(widget.bill.id, {
      'amount': amount,
      'category_id': cat.id,
      'category_name': cat.name,
      'type': _type == BillType.income ? 'income' : 'expense',
